                                         ...
                                         m_bGameOn(true)
{
  ...
  //SoccerTeam2 *s = new SoccerTeam2(m_pRedGoal, m_pBlueGoal, this, SoccerTeam::red);
  //create the teams 
  m_pRedTeam  = new SoccerTeam2(m_pRedGoal, m_pBlueGoal, this, SoccerTeam::red);
  m_pRedTeam->initialize();
  m_pBlueTeam = new SoccerTeam(m_pBlueGoal, m_pRedGoal, this, SoccerTeam::blue);
  m_pBlueTeam->initialize();
...
void SoccerPitch::Update()
{
  ...
  if (m_pBlueGoal->Scored(m_pBall) || m_pRedGoal->Scored(m_pBall))
  {
	...
	OutputDebugString("SoccerPitch.Update: removed calls to teamstate instance to deal with freezing issues\n");
